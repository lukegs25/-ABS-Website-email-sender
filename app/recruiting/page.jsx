...
export default async function RecruitingPage() {
  ...
  const isUnlocked = eventsAttended >= 3;
      ...
      {isUnlocked ? (
        ...
        <section className="rounded-xl border border-gray-200 bg-white p-8 shadow-sm text-center">
          ...
          <p className="mt-2 text-gray-600">
            Attend 3 ABS meetings to earn your AI Proficiency Certificate and gain access to exclusive AI job opportunities.
          </p>
